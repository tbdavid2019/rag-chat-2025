...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ 
    stores, onSelectStore, onDeleteStore, onCreateStore, isApiKeySelected, onSelectKey, isLoading, apiKeyError 
}) => {
                    ...
                    {!isApiKeySelected ? (
                        <form onSubmit={handleApiKeySubmit} className="flex gap-2 w-full md:w-auto">
                            <input 
                                ...
                                className={`px-4 py-2 border rounded-lg focus:ring-2 focus:ring-gem-blue outline-none w-full md:w-64 transition-colors ${
                                    apiKeyError ? 'border-red-500 bg-red-50' : 'border-gem-mist'
                                }`}
                            />
                            <button 
                                type="submit"
